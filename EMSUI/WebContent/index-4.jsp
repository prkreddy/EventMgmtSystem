					...
					<div class="right">
						...
						<nav>
							...
							<li><a href="index-3.html">Charters</a></li> -->
								<li id="menu_active"><a href="index-4.jsp">Contacts</a></li>
							</ul>
						</nav>
					</div>
				</div>
			...
			<article class="col1">
				<div class="pad_1">
					...
					<p>At vero eos et accusamus et iusto odio dignissimos ducimus
						...
						provident, similique sunt in culpa qui officia.</p> -->
				</div>
			</article>
				...
				<form id="ContactForm" action="">
					<div>
						...
						<a href="#" class="button2"
							onClick="document.getElementById('ContactForm').submit()">submit</a>
						<a href="#" class="button2"
							onClick="document.getElementById('ContactForm').reset()">reset</a>
					</div>
				</form>
			</article>
		</section>
